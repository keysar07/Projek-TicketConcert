<div class="quixnav">
    <div class="quixnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a href="{{ route('pesan') }}" aria-expanded="false"><i class="icon icon-single-04"></i><span
            class="nav-text {{ Request::is('Pesan') ? "active" : '' }}">Pesan Tiket</span></a></li>
            <li><a href="{{ route('riwayat') }}" aria-expanded="false"><i class="icon icon-single-04"></i><span
            ...
            @endhasrole
            <li><a href="{{ route('metode') }}" aria-expanded="false"><i class="icon icon-single-04"></i><span
