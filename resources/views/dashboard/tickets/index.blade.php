<x-dashboard-layout>
    ...
    <div class="card card-user" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('kelas-service-insert') }}">
            @csrf
            <div class="row">
            ...
            <div class="row">
                ...
                <button type="submit" class="btn btn-rounded btn-primary">Tambah Kelas</button>
                </div>
            </div>
            </form>
        </div>
                     ...
                     <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-rounded btn-outline-success mr-1" href="{{ route('kelas-detail', $s->id) }}"><i class="bi bi-ticket-detailed"></i> Detail</a>
                                <a class="btn btn-rounded btn-outline-warning mr-1" href="{{ route('kelas-update',$s->nama_kelas) }}"><i class="bi bi-pencil-fill"></i> Edit</a>
                                <form action="{{ route('kelas-service-destroy', $s) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
